...
class Serie {
    ...
    Serie(String nome, String idioma, String duracao, String formato, String pais, String emissora, String transmicao,
...
public class tempo {
    ...
    public static boolean pesquisaSequencial(String nome, Serie serie[], int numEntrada) {
        boolean resp = false;

        //numEntrada é o numero de series lidos na main
        for (int i = 0; i < numEntrada; i++) {
            if (serie[i].getNome().contains(nome)) { //se o nome está dentro do html
                count++;
                resp = true;
                i = numEntrada;//evitar comparações desnecessárias---quando já achar o nome da serie
            }
        }
    ...
    public static void main(String[] args) throws Exception {
        ...
        int numEntrada = 0;
        Serie[] lista = new Serie[70];
        //String url = "/tmp/series/";//verde
        String url = "series/";
        String pesquisaNome = "";
        ...
        while (isFim(pesquisaNome) == false ) {
            ...
            if(pesquisaSequencial(pesquisaNome, lista, numEntrada) == true){
                MyIO.println("SIM");
            }
