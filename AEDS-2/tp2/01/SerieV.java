...
SerieV(String nome, String idioma, String duracao, String formato, String pais, String emissora, String transmicao, int temporadas, int episodios){
    this.nome = nome;
    this.idioma = idioma;
...
public void ler(String endereco, String nome) throws Exception{
...
public String imprimir(){
    return this.nome + " " + this.formato + " " + this.duracao + " " + this.pais + " "+ this.idioma + " " + this.emissora + " " + this.transmicao + " " + this.temporadas + " " + this.episodios;
...
public static void main(String [] args)throws Exception{
    ...
    String[] entrada = new String[1000];
        ...
        //construtor
        SerieV item = new SerieV();
        //variáveis
        //String endereco, nome, url= "";
        ...
        for (int i = 0; i < numEntrada; i++) {
            ...
            item = new SerieV();
            endereco = url + nome;
            item.ler(endereco, nome);
            MyIO.println(item.imprimir());
        }
