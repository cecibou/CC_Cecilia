...
*/
   ...
   public static int tamanhoEntrada(String myExpression) {
      ...
      tam = Integer.parseInt(pedacoString(myExpression,0, pos));
      return tam;
   }
   ...
   public static String variaveisEntrada(String myExpression) {
      ...
      variavel = pedacoString(myExpression, pos + 1, (pos + 1) + (tam * 2));
   ...
   public static String expressaoEntrada(String myExpression) {
      ...
      tam = Integer.parseInt(pedacoString(myExpression,0, pos));
      expressao = pedacoString(myExpression, ((pos) + (tam * 2)) + 1, (myExpression.length()));
...
public static boolean CalcularExpressao(String Expression,String Variaveis){
   ...
   if (Expression.length() <= 3){
      ...
      if (Expression.charAt(0) == 'n' && Expression.charAt(1) == 'o' && Expression.charAt(2) == 't'){
         subexpAux = pedacoString(Expression,3,Expression.length());
         ...
         if (Expression.charAt(0) == 'a'&&Expression.charAt(1) == 'n'&&Expression.charAt(2) == 'd'){
            resultado = true;
            for (i=1;i<=10;i++){
               subexpAux = parteExpression(pedacoString(Expression,3,Expression.length()),i); 
            ...
            resultado = false;
            for (i=1;i<=10;i++){
               subexpAux = parteExpression(pedacoString(Expression,2,Expression.length()),i); 
