...
public class ListaQ {
    ...
    private int n;
    public ListaQ (int maxTam) { // A constante maxTam define o tamanho maximo permitido na lista
    ...
    public static void main(String[] args) throws Exception {
        ...
        lista.quicksort(0,numEntrada-1);
        lista.mostrar();
    }
}