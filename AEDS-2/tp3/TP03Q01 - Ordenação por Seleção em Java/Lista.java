...
public class Lista {
    ...
    public Lista (int maxTam) { // A constante maxTam define o tamanho maximo permitido na lista
    ...
    public static void main(String[] args) throws Exception {
        ...
        for(int i = 0; i<n; i++){
            ...
            String primeiraParte = linha.substring(0, 2);
            //ver qual eh a funçãoa ser usada
            if(primeiraParte.equals("II")){
                //inserir no inicio
                String segundaParte = linha.substring(3);
            ...
            if(primeiraParte.equals("I*")){
                ...
                String segundaParte = linha.substring(3,5);
                int pos = Integer.parseInt(segundaParte);
                String terceiraParte = linha.substring(6);
                String endereco = url + terceiraParte;
                s = new SerieV();
                s.ler(terceiraParte, endereco);
                lista.inserir(s, pos);            
            }
            if(primeiraParte.equals("IF")){
                //inserir no fim
                String segundaParte = linha.substring(3);
                String endereco = url + segundaParte;
                s = new SerieV();
